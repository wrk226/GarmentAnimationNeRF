...
class CustomMappingNetwork(nn.Module):
    def __init__(self, z_dim, map_hidden_dim, map_output_dim):
        ...
        # torch.set_printoptions(edgeitems=99999,linewidth=99999,sci_mode=False)
...
class GeoSIREN(nn.Module):
    ...
    def __init__(self, input_dim=2, z_dim=100, hidden_dim=256, output_dim=1, device=None, last_op=None, scale=1.):
        super().__init__()
        self.device = device
        self.input_dim = input_dim
        self.z_dim = z_dim
