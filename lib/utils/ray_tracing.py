...
class RayTracing(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.object_bounding_sphere = cfg.object_bounding_sphere
        self.sdf_threshold = cfg.sdf_threshold
        self.sphere_tracing_iters = cfg.sphere_tracing_iters
        self.line_step_iters = cfg.line_step_iters
        self.line_search_step = cfg.line_search_step
        self.n_steps = cfg.n_steps
        self.n_secant_steps = cfg.n_secant_steps
    ...
    def forward(self,
        ...
        # 这个需要换成bbox intersection
        sphere_intersections, mask_intersect = self.get_sphere_intersection(cam_loc, ray_directions, r=self.object_bounding_sphere)
    ...
    def get_sphere_intersection(self, cam_loc, ray_directions, r = 1.0):
