...
class Dataset(data.Dataset):
    ...
    def get_curr_frame_data(self, index, rotate_idx):
    ...
    def __getitem__(self, index):
        ...
        real_index = cfg.prev_frames * self.num_cams + np.where(self.cam_inds==cfg.test_cam_pose)[0][0]
        frame_idx = real_index // self.num_cams
        ret = self.get_curr_frame_data(real_index, rotate_idx=index)
